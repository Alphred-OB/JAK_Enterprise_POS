...
<div class="min-h-screen bg-[#fafbfc] p-8">
    ...
    <header class="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 gap-6">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <button onclick="window.installPWA()" class="bg-blue-50 text-blue-600 px-6 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-blue-100 transition-all shadow-sm active:scale-95 flex items-center gap-3">
