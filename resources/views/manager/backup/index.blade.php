    ...
    <div class="grid grid-cols-1 gap-8">
        ...
        <div class="bg-white rounded-[40px] p-12 border border-slate-100 shadow-sm text-center relative overflow-hidden group">
            ...
            <div class="relative z-10 flex flex-col items-center">
                <div class="w-16 h-16 md:w-24 md:h-24 bg-blue-600 text-white rounded-2xl md:rounded-[32px] flex items-center justify-center mb-6 md:mb-8 shadow-2xl shadow-blue-200 animate-bounce-slow">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 md:h-10 md:w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                </div>
        ...
        <div class="bg-amber-50 rounded-[32px] p-6 md:p-8 border border-amber-100 flex flex-col md:flex-row gap-6">
            <div class="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-amber-600 shadow-sm shrink-0 mx-auto md:mx-0">
