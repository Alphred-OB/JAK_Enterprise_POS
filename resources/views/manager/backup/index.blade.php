...
<div class="p-8 max-w-4xl mx-auto">
    <header class="mb-12">
        <h1 class="text-3xl font-black text-slate-900 tracking-tight">Database Backup & Recovery</h1>
        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1">Protect your business data with secure system snapshots</p>
    </header>
    ...
    <div class="grid grid-cols-1 gap-8">
        ...
        <div class="bg-white rounded-[40px] p-12 border border-slate-100 shadow-sm text-center relative overflow-hidden group">
            ...
            <div class="relative z-10 flex flex-col items-center">
                <div class="w-24 h-24 bg-blue-600 text-white rounded-[32px] flex items-center justify-center mb-8 shadow-2xl shadow-blue-200 animate-bounce-slow">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                </div>
                
                <h2 class="text-2xl font-black text-slate-900 tracking-tight mb-4">Generate System Snapshot</h2>
                <p class="text-slate-500 font-bold text-sm max-w-md mx-auto mb-10">
                ...
                <a href="{{ route('admin.backup.download') }}" class="bg-slate-900 text-white px-12 py-5 rounded-[24px] font-black text-xs uppercase tracking-[0.2em] hover:bg-blue-600 transition-all shadow-2xl shadow-slate-200 active:scale-95">
