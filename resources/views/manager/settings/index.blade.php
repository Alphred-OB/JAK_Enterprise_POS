...
<div class="p-8">
    <header class="mb-10">
        <h1 class="text-3xl font-black text-slate-900 tracking-tight">Shop Settings</h1>
        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1">Customize your brand identity and system defaults</p>
    </header>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="flex items-center justify-end pt-4">
                        <button type="submit" class="bg-slate-900 text-white px-12 py-5 rounded-[24px] font-black text-xs uppercase tracking-[0.2em] hover:bg-blue-600 transition-all shadow-2xl shadow-slate-200 active:scale-95">
                            Save Configuration
                        </button>
                    </div>
                </div>
