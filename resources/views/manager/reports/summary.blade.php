...
<body class="bg-slate-50 p-4 md:p-12">
    <div class="max-w-4xl mx-auto bg-white shadow-2xl rounded-[40px] p-12 report-card border border-slate-100">
        <!-- Report Header -->
        <header class="flex justify-between items-start mb-16 border-b border-slate-100 pb-12">
            <div>
                <h1 class="text-4xl font-black text-slate-900 tracking-tighter uppercase mb-2">Business Summary</h1>
                <p class="text-xs font-bold text-blue-600 uppercase tracking-[0.3em]">Generated on {{ now()->format('d M, Y • h:i A') }}</p>
            </div>
        ...
        <!-- Time Range -->
        <div class="bg-slate-900 text-white rounded-3xl p-8 mb-12 flex justify-between items-center shadow-2xl shadow-slate-200">
            <div>
            ...
            <button onclick="window.print()" class="no-print bg-white text-slate-900 px-6 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-500 hover:text-white transition-all shadow-lg">Print / Save PDF</button>
        </div>
        ...
        <div class="grid grid-cols-3 gap-8 mb-16">
            ...
            <div class="p-8 bg-blue-600 rounded-3xl shadow-xl shadow-blue-100">
