...
<div class="p-8 max-w-2xl">
    <header class="mb-12">
        ...
        <h1 class="text-4xl font-black text-slate-900 tracking-tight">Log New Expense</h1>
        <p class="text-sm font-bold text-slate-500 uppercase tracking-widest mt-1">Record outgoing money for your shop</p>
    </header>
    ...
    <form action="{{ route('manager.expenses.store') }}" method="POST" class="space-y-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('manager.expenses.index') }}" class="px-10 py-6 bg-white border border-slate-100 rounded-[24px] text-[10px] font-black text-slate-400 uppercase tracking-widest hover:bg-slate-50 transition-all">Cancel</a>
        </div>
    </form>
</div>
@endsection
