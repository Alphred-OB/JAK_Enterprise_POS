...
<div class="p-8 max-w-4xl mx-auto">
    <header class="flex items-center gap-6 mb-10">
        ...
        <div>
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Add Supplier</h1>
            <p class="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1">Register a new business partner</p>
        </div>
    </header>
    ...
    <form action="{{ route('manager.suppliers.store') }}" method="POST" class="space-y-8">
        ...
        <div class="flex items-center justify-end gap-4">
            ...
            <button type="submit" class="bg-blue-600 text-white px-12 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl shadow-blue-100 active:scale-95">Save Supplier</button>
        </div>
    </form>
</div>
@endsection
